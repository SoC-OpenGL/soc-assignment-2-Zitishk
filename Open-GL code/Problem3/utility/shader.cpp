...
/*
void ShaderProgram:: setprob(const std::string &name,glm::vec3 &diffuse,glm::vec3 &ambient,glm::vec3 &specular,float shining)
{
    setvec3(name+".diffuse",diffuse);
    setvec3(name+".ambient",ambient);
    setvec3(name+".specular",specular);
    setfloat(name+".shininess",shining);
...
void ShaderProgram:: setlight(const std::string &name,glm::vec3 &diffuse,glm::vec3 &ambient,glm::vec3 &specular,glm::vec3 &pos)
{
    setvec3(name+".diffuse",diffuse);
    setvec3(name+".ambient",ambient);
    setvec3(name+".specular",specular);
...
*/
void ShaderProgram:: setlight(const std::string &name,glm::vec3 &color,glm::vec3 &pos)
{
